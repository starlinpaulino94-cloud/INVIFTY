 ...
 *  - select_demo_style  : clic en un filtro de tipo de evento o en el selector de demos
 ...
 *  - begin_brief        : primer foco en un campo del formulario de cotización
 *  - submit_lead        : cuando se envía el formulario de cotización (lead cualificado)
 */
