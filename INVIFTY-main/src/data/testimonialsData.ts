...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    location: "Miami, FL",
    comment: {
      es: "A nuestros invitados les fascinó la invitación. La confirmación por WhatsApp nos ahorró días enteros organizando las mesas. El equipo de Invifty entregó todo impecable y a tiempo.",
      en: "Our guests were fascinated by the invitation. The WhatsApp RSVP saved us entire days of seating planning. The Invifty team delivered everything flawlessly and right on time."
    },
    rating: 5,
    date: "Junio 2026",
