  ...
  return (
    <section id="planes" ref={sectionRef} className="py-24 bg-[#151515] border-t border-white/5 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {customPlan && (
          <div className="relative mb-8 border border-[#D4AF37]/40 bg-gradient-to-r from-[#1A1A1A] via-[#151515] to-[#0A0A0A] p-8 lg:p-10 overflow-hidden">
            <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#D4AF37]/10 rounded-full filter blur-3xl pointer-events-none"></div>

            <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              {/* Identidad del plan a medida */}
              <div className="lg:col-span-5">
                <div className="inline-flex items-center gap-2 bg-[#D4AF37]/10 border border-[#D4AF37]/40 text-[#D4AF37] text-[10px] uppercase tracking-[0.2em] font-bold px-3 py-1.5 mb-5">
                ...
                <div className="flex items-baseline gap-1.5 mb-3">
                  ...
                  <span className="text-xs text-[#D4AF37] font-semibold">{isEs ? "RD$" : "$"}</span>
              ...
              <div className="lg:col-span-4">
                <span className="text-[10px] font-semibold text-white/40 uppercase tracking-widest block mb-4">
                ...
                <a
                  ...
                  onClick={() =>
                    trackEvent("select_plan", {
                      ...
                      price: isEs ? customPlan.priceDOP : customPlan.priceUSD,
                      currency: isEs ? "DOP" : "USD",
                      placement: "pricing_custom",
                    })
                  }
                  className="w-full inline-flex items-center justify-center gap-2 bg-[#D4AF37] text-black font-bold text-[10px] uppercase tracking-[0.2em] py-4 rounded-xl min-h-[48px] hover:bg-[#F2D06B] active:scale-95 transition-all duration-300 touch-manipulation shadow-lg"
                >
                  <MessageCircle className="w-4 h-4" />
                  {lx(customPlan.ctaText)}
                </a>
                <p className="text-center text-[10px] text-white/35 mt-3 italic">
