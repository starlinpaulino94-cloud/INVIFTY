...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "hero.subtitle": "Diseños interactivos personalizados para bodas, cumpleaños y galas en República Dominicana. Confirmación RSVP directa por WhatsApp, mapas interactivos, mesa de regalos, música y pases con código QR.",
  ...
  en: {
    ...
    "hero.subtitle": "Custom interactive designs for destination weddings, birthdays, and corporate galas in the Dominican Republic. Direct WhatsApp RSVP, interactive maps, gift registry, background music, and QR passcodes.",
