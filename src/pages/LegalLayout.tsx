...
export default function LegalLayout({ titleEs, titleEn, updatedEs, updatedEn, onBackToHome, children }: LegalLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-[#EAEAEA] font-sans-clean">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">

        <button
          onClick={onBackToHome}
          className="inline-flex items-center gap-2 text-[10px] uppercase tracking-[0.25em] text-[#D4AF37] hover:text-[#F2D06B] transition-colors mb-10 font-semibold"
        >
        ...
        <p className="text-white/40 text-xs italic font-light mb-12">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-xs text-white/40 font-light italic">
          {isEs
